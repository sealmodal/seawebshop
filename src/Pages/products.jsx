        ...
        <main className="main">
          ...
          <div className="products">
            ...
            <div className="product">
              ...
              />
              <figcaption>
                <h4>Assorted Sticker Sheets</h4>Vinyl sticker mix with various
                themes. Comes in matte and glossy finishes.
              </figcaption>
            </div>
            {/**/}
            <div className="product">
              ...
              />
              <figcaption>
                <h4>Fish Rubber Stamp</h4>Handmade fish stamp on rubber (ink not
                included).
              </figcaption>
            </div>
            <div className="product">
            ...
            <div className="product">
              ...
              />
              <figcaption>
                <h4>Apple Phonestrap</h4>Handmade phonestraps in different des.
              </figcaption>
            </div>
          </div>
        </main>
